...
contract UniV2LpOracle is IOracle {
    ...
    */
    ...
    /// @inheritdoc IOracle
    function getPrice(address pair,address account) external view returns (uint) {
        ...
        return FixedPointMathLib.sqrt(
            r0
            .mulWadDown(r1)
            .mulWadDown(oracle.getPrice(token0,msg.sender))
            .mulWadDown(oracle.getPrice(token1,msg.sender))
